...
TIP: to integrate 3rd party lib, Framework or legacy code

TIP: change exisiting configuration or behavior
...
TIP: just put the qualified name of your extension class in this file
